...
function updateCartContainer(e) {
  ...
  productTitle = productContainer.getElementsByClassName("productTitle")[0]
    .innerText;
  productPrice = productContainer.getElementsByClassName("productPrice")[0]
    .innerText;
...
<div class="col-xs-3 cartPrice"> ${productPrice}</div>
 <div class="col-xs-3 removeButton"> Remove</div>`;
  ...
  document.getElementsByClassName("cartTotalPrice")[0].innerText = new Number(
    totalPrice
  ).toLocaleString("en");
